...
const Hero = () => {
  return (
    <section className="section ml-[-10px] w-full mt-[60px] lg:mt-0 mb-20 xl:mt-20 xl:mb-[120px] overflow-x-hidden ">
      ...
      <div className="herotextcontainer w-full xs:w-[95%] sm:w-[80%] lg822:w-[60%] lg:w-[42%] xl:w-[45%] lg:mt-6 lg:block lg:text-left flex justify-center items-center flex-col text-center mt-0">
      <div className="HeroText w-full flex justify-center items-center flex-col text-center lg:text-left lg:block lg:w-auto">
